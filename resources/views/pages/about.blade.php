...
<section class="py-16">
  <div class="max-w-shell mx-auto px-5 lg:px-8 grid lg:grid-cols-[0.8fr_1.2fr] gap-10">
    ...
    <div class="space-y-6">
      @foreach([
        ['2025', 'One spreadsheet', 'Fourteen freelancers, a WhatsApp group and a Google Sheet tracking who was free. It worked, and it did not scale.'],
        ['2026', 'The engine', 'Scored matching, escrow and the QA gate replaced the spreadsheet. Turnaround dropped from days to hours.'],
        ['2027', 'Brief engine and pods', 'Briefs became automatic, repurposing shipped, and teams started running dedicated expert pods.'],
      ] as $i => [$year, $t, $b])
...
@include('partials.cta', [
  ...
  'title'     => 'Hiring freelancers, and talking to teams who publish weekly.',
