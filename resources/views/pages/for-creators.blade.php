...
<section class="pt-16 pb-12">
  <div class="max-w-shell mx-auto px-5 lg:px-8 grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
    ...
    {{-- incoming gig card --}}
    <div class="relative">
      <div class="absolute -inset-6 bg-mint-wash blur-3xl rounded-full -z-10"></div>
      <div class="glass-strong rounded-3xl p-6 ring-glow">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2 text-[11px] font-semibold tracking-[.14em] uppercase text-faint">
            <span class="w-1.5 h-1.5 rounded-full bg-mint pulse-dot text-mint-deep"></span> New gig offer
          </div>
          <span class="text-[11.5px] font-mono text-faint">expires in 9:41</span>
        </div>
        ...
        <div class="mt-5 grid grid-cols-2 gap-3">
          <div class="rounded-2xl border border-line bg-tint px-4 py-3">
            <div class="text-[11px] text-mut">Your payout</div>
            <div class="text-[19px] font-semibold font-mono text-mint-deep">₹3,598</div>
          </div>
          <div class="rounded-2xl border border-line bg-tint px-4 py-3">
        ...
        <div class="mt-4 rounded-2xl border border-line bg-tint p-4">
          <div class="text-[11px] font-semibold tracking-[.12em] uppercase text-faint">Included with the offer</div>
...
{{-- ── earnings calculator ── --}}
<section id="earnings" class="py-16 border-y border-line scroll-mt-20">
      ...
      <div class="glass rounded-3xl p-6 sm:p-7 space-y-7">
        <div>
          <div class="flex items-center justify-between text-[13.5px]">
            <span>Gigs per week</span><span class="font-mono text-body" x-text="perWeek"></span>
          </div>
          <input type="range" min="1" max="20" x-model.number="perWeek" class="mt-2.5 w-full accent-violet cursor-pointer">
        </div>
        <div>
          <div class="flex items-center justify-between text-[13.5px]">
            <span>Average gig price</span><span class="font-mono text-body" x-text="'₹' + price.toLocaleString('en-IN')"></span>
          </div>
        ...
        <label class="flex items-center gap-3 text-[13.5px] text-mut pt-2 border-t border-line">
          <input type="checkbox" x-model="express" class="w-4 h-4 rounded border-line bg-tint accent-violet">
      ...
      <div class="space-y-4">
        ...
        <div class="glass rounded-3xl p-6">
          <div class="text-[13px] text-mut leading-6">
            ...
            <span class="font-mono text-body" x-text="'₹' + elsewhere.toLocaleString('en-IN')"></span> —
            <span class="text-mint-deep font-medium" x-text="'₹' + (takeHome - elsewhere).toLocaleString('en-IN') + ' less'"></span>,
...
<section class="band-lav py-20">
  <div class="max-w-shell mx-auto px-5 lg:px-8">
    <div class="max-w-[620px]">
      <div class="text-[11px] font-semibold tracking-[.16em] uppercase text-mint-deep">How work reaches you</div>
    ...
    <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
      @foreach([
        ...
        <div class="reveal glass rounded-3xl p-6 card-hover" style="transition-delay: {{ $i * 70 }}ms">
          <div class="font-display text-[30px] font-semibold text-ink/10">0{{ $i + 1 }}</div>
...
<section class="py-16 border-y border-line">
  <div class="max-w-shell mx-auto px-5 lg:px-8 grid lg:grid-cols-2 gap-6">
    <div class="glass rounded-3xl p-7">
      <div class="text-[11px] font-semibold tracking-[.14em] uppercase text-mint-deep">Freelancer copilot</div>
    ...
    <div class="glass rounded-3xl p-7">
      <div class="text-[11px] font-semibold tracking-[.14em] uppercase text-mint-deep">Fair by design</div>
