<?php $isCreator = request()->is('creator*'); ?>
<?php if(!$isCreator): ?>
<div class="footer">
  <a href="<?php echo e(url('/')); ?>" class="footer-item active" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;color:var(--text);text-decoration:none;font-size:10.5px;font-weight:600;padding:4px 0">
  ...
  <a href="<?php echo e(url('/')); ?>#search" class="footer-item" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;color:var(--muted);text-decoration:none;font-size:10.5px;font-weight:600;padding:4px 0">
  ...
  <a href="<?php echo e(route('orders.show','UNJ-8841')); ?>" class="footer-item" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;color:var(--muted);text-decoration:none;font-size:10.5px;font-weight:600;padding:4px 0">
...
<?php else: ?>
<div class="footer">
  <a href="<?php echo e(route('creator.dashboard')); ?>" class="footer-item active" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;color:var(--text);text-decoration:none;font-size:10.5px;font-weight:600;padding:4px 0">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M3 10L12 3l9 7v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z"/></svg> Home
  </a>
  <div class="footer-item" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;color:var(--muted);font-size:10.5px;font-weight:600;padding:4px 0">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\quick-content-laravel\resources\views/components/footer.blade.php ENDPATH**/ ?>